        ...
        <div class="service-modal-footer">
          <div class="modal-footer-cta">
            ...
            <div class="modal-footer-cta-actions">
              <a href="https://wa.me/528111058875?text=${proj.waMessage}" target="_blank" rel="noopener noreferrer" class="btn-whatsapp-modal">
...
Por favor confirmar disponibilidad en stock, costos de envío y tiempo de entrega.`;
    ...
    const whatsappUrl = `https://wa.me/528111058875?text=${encodeURIComponent(message)}`;
